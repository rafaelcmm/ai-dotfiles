...
Compatibility note: top-level template instruction files were removed. Platform guidance is now defined through instruction/rule trees under `.github/instructions`.
